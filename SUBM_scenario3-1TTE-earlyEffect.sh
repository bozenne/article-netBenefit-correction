...
#$ -N scenario3-1TTE-earlyEffect  # Job name
...
#$ -o output/scenario3-1TTE-earlyEffect/   # Direct output to subdirectory
#$ -e output/scenario3-1TTE-earlyEffect/   # Direct output to subdirectory

R CMD BATCH BATCH_scenario3-1TTE-earlyEffect.R output/scenario3-1TTE-earlyEffect/$JOB_NAME-I-$SGE_TASK_ID.Rout --no-restore --no-save

## go to directory    ## cd p:/Cluster/GPC/Article-correction-Julien/
## clean outputs      ## rm -r ./output/scenario3-1TTE-earlyEffect/*
