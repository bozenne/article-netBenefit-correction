...
#$ -o output/scenario5-TTE-bin/   # Direct output to subdirectory
#$ -e output/scenario5-TTE-bin/   # Direct output to subdirectory

R CMD BATCH BATCH_scenario5-TTE-bin.R output/scenario5-TTE-bin/$JOB_NAME-I-$SGE_TASK_ID.Rout --no-restore --no-save

## go to directory    ## cd p:/Cluster/GPC/Article-correction-Julien/
## clean outputs      ## rm -r ./output/scenario5-TTE-bin/*
