...
## setwd(path)
## source("BATCH_scenario6-1TTE-tau0-weibull.R")
...
## * path
path <- "."
path.res <- file.path(path,"Results","scenario6-1TTE-tau0-weibull")
if(dir.exists(path.res)==FALSE){
    dir.create(path.res)
}
path.output <- file.path(path,"output","scenario6-1TTE-tau0-weibull")
